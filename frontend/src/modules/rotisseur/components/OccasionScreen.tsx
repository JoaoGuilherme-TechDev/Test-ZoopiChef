...
import type { MeatOccasion } from '../types';
import { OCCASIONS } from '../types';

interface OccasionScreenProps {
  onSelectOccasion: (occasion: MeatOccasion) => void;
  onBack: () => void;
}

export function OccasionScreen({ onSelectOccasion, onBack }: OccasionScreenProps) {
  return (
    <div className="min-h-screen flex flex-col p-6 bg-gradient-to-b from-red-950/30 via-background to-background">
      ...
      <div className="text-center mb-8 pt-8">
        ...
        <p className="text-muted-foreground">
          Isso nos ajuda a sugerir as melhores opções
        </p>
      </div>
