...
>(({ side = "left", variant = "sidebar", collapsible = "icon", className, children, ...props }, ref) => {
  ...
  // Some callers may spread objects that include a `ref` key (as a normal prop).
  // If we forward that into Radix components (Sheet/Dialog), React will warn.
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  const { ref: _refProp, ...safeProps } = props as any;
